...
### Training
You can manually download the pretained weight [here](https://dl.fbaipublicfiles.com/detectron/ImageNetPretrained/MSRA/R-101.pkl).   
...
```
python tools/train_net.py --num-gpus 1 \
        --config-file configs/PASCAL_VOC/split1/10shot.yml \
...
You can use `run_voc.sh` to do the training and evaluation.  
**VOC:**
```
bash run_voc.sh
```
